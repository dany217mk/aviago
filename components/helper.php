    ...
    public function outputCommonHead($title, $menu_active='', $styles=[]){
      ...
      public function getMenu($access_level){
        ...
        if ($access_level == 10){
             ...
             $menu[] = array("name" => "Рейсы а/к", "link" => "airline_flights", "icon" => '<i class="fa-solid fa-plane-departure"></i>');
             $menu[] = array("name" => "Заявки на чартеры", "link" => "airline_charters", "icon" => '<i class="fa-solid fa-comments"></i>');
            ...
            $menu[] = array("name" => "Личный кабинет", "link" => "profile", "icon" => '<i class="fa-solid fa-user"></i>');
            $menu[] = array("name" => "Мое расписание", "link" => "my_schedule", "icon" => '<i class="fa-solid fa-calendar-days"></i>');
            $menu[] = array("name" => "История рейсов", "link" => "my_flight_history", "icon" => '<i class="fa-solid fa-clock-rotate-left"></i>');    
        } else{
           $menu[] = array("name" => "Личный кабинет", "link" => "profile", "icon" => '<i class="fa-solid fa-user"></i>');

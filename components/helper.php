    ...
    public function outputCommonHead($title, $menu_active='', $styles=[]){
      ...
      public function getMenu($access_level){
        ...
        if ($access_level == 10){
             ...
             $menu[] = array("name" => "Самолеты", "link" => "efef", "icon" => '<i class="fa-solid fa-plane"></i>');
             $menu[] = array("name" => "Инструкции", "link" => "efef", "icon" => '<i class="fa-solid fa-circle-question"></i>');
           ...
           $menu[] = array("name" => "Личный кабинет", "link" => "/profile", "icon" => '<i class="fa-solid fa-user"></i>');
            $menu[] = array("name" => "Мои билеты", "link" => "efef", "icon" => '<i class="fa-solid fa-ticket"></i>');
            $menu[] = array("name" => "История покупок", "link" => "efef", "icon" => '<i class="fa-solid fa-clock-rotate-left"></i>');
            $menu[] = array("name" => "Заявки на чартеры", "link" => "efef", "icon" => '<i class="fa-solid fa-comments"></i>'); 
        }
